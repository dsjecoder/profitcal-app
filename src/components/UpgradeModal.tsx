      ...
      <div className="bg-gradient-to-b from-navy-900 via-navy-950 to-navy-900 border border-amber-500/40 rounded-3xl w-full max-w-2xl overflow-hidden shadow-2xl shadow-amber-500/10 relative">
        ...
        {showPaymentQR ? (
          ...
          <div className="p-8 text-center space-y-6">
            ...
            <div className="bg-navy-900 p-4 rounded-2xl border border-navy-800 text-xs space-y-2 text-left max-w-md mx-auto">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-mono font-bold text-amber-400">0988 888 999</span>
              </div>
              <div className="flex justify-between">
                <span className="text-slate-400">Số tiền:</span>
                <span className="font-mono font-bold text-emerald-400">199.000 VNĐ</span>
              </div>
          ...
          <div className="p-6 sm:p-8 space-y-6">
            ...
            <div className="text-center space-y-2">
              ...
              <p className="text-xs text-slate-300 max-w-md mx-auto">
                Token miễn phí tiếp theo sẽ tự động cấp sau 7 ngày. Để soi file ngay lập tức <strong className="text-amber-300">không giới hạn</strong> và nhận đồng bộ Cloud, nâng cấp ngay chỉ <strong className="text-emerald-400">199.000đ / năm</strong>.
              </p>
            </div>
              ...
              <table className="w-full text-left text-xs">
                <thead className="bg-navy-900 border-b border-navy-800 text-slate-400 uppercase font-bold">
                  <tr>
                    ...
                    <th className="py-3 px-4 text-center text-amber-400 bg-amber-500/10">Gói PRO (199k/năm)</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-navy-800/60 font-medium">
                  <tr>
                    <td className="py-3 px-4 text-slate-300 font-bold">Hạn mức Token phân tích</td>
                    <td className="py-3 px-4 text-center text-slate-400">1 – 2 Token / Tuần</td>
                    <td className="py-3 px-4 text-center font-bold text-amber-400 bg-amber-500/5">KHÔNG GIỚI HẠN</td>
                  </tr>
                  <tr>
                    <td className="py-3 px-4 text-slate-300 font-bold">Giới hạn số đơn/file</td>
                    <td className="py-3 px-4 text-center text-slate-400">Tối đa 200 đơn</td>
                    <td className="py-3 px-4 text-center font-bold text-emerald-400 bg-amber-500/5">Không giới hạn</td>
                  </tr>
                  <tr>
                    <td className="py-3 px-4 text-slate-300 font-bold">Mở toàn bộ Bảng Soi Phí/Đơn Lỗi</td>
                    <td className="py-3 px-4 text-center text-emerald-400 font-bold">Có (Mở 100%)</td>
                    <td className="py-3 px-4 text-center font-bold text-emerald-400 bg-amber-500/5">Có (Mở 100%)</td>
                  </tr>
                  <tr>
                    <td className="py-3 px-4 text-slate-300 font-bold">Xuất Báo Cáo Excel Chi Tiết</td>
                    <td className="py-3 px-4 text-center text-slate-400">1 lần / tuần</td>
                    <td className="py-3 px-4 text-center font-bold text-emerald-400 bg-amber-500/5">Xuất Không Giới Hạn</td>
                  </tr>
                  <tr>
                    <td className="py-3 px-4 text-slate-300 font-bold">Lưu trữ Giá vốn (COGS)</td>
                    <td className="py-3 px-4 text-center text-slate-400">Lưu Trình duyệt (Local)</td>
                    <td className="py-3 px-4 text-center font-bold text-cyan-400 bg-amber-500/5">Đồng Bộ Cloud Vĩnh Viễn</td>
                  </tr>
                </tbody>
              </table>
            </div>
