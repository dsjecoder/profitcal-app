    ...
    <div className="space-y-8 animate-fade-in w-full">
      ...
      <form onSubmit={handleSaveSettings} className="space-y-6 w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full">
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-3xl p-6 shadow-2xl flex flex-col justify-between space-y-4">
            <div className="space-y-3">
              ...
              <div className="p-3 bg-slate-950/80 rounded-xl border border-slate-800/80 text-[11px] text-slate-400 leading-relaxed">
                💡 <strong className="text-slate-300">Lưu ý:</strong> Thay đổi giá vốn tại đây áp dụng cho các phiên tính toán hiện tại, không tự động thay đổi giá vốn của các đơn hàng lịch sử.
              </div>
            </div>
            ...
            <button
              ...
              className="w-full py-2.5 px-4 rounded-xl bg-slate-800 hover:bg-slate-700 text-slate-200 border border-slate-700 font-bold text-xs transition-colors flex items-center justify-center gap-2"
            >
              ...
              <div className="space-y-1.5 pt-2">
                ...
                <div className="flex items-center gap-2">
                  <input
                    ...
                    className="w-full bg-slate-950 border border-slate-700 rounded-xl px-3.5 py-2 text-right font-mono font-bold text-sm text-emerald-400 focus:outline-none focus:border-emerald-500"
                  />
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-3xl p-6 shadow-2xl flex flex-col justify-between space-y-4">
            <div className="space-y-3">
              <div className="w-10 h-10 rounded-xl bg-emerald-500/10 border border-emerald-500/20 flex items-center justify-center text-amber-400">
              ...
              <div className="space-y-1.5 pt-2">
                ...
                <div className="flex items-center gap-2">
                  <input
                    ...
                    className="w-full bg-slate-950 border border-slate-700 rounded-xl px-3.5 py-2 text-right font-mono font-bold text-sm text-amber-400 focus:outline-none focus:border-amber-500"
                  />
      ...
      <div className="bg-slate-900/60 border border-slate-800 p-4 rounded-2xl text-xs text-slate-400 flex items-center gap-2.5 w-full">
