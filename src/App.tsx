...
export function App() {
  ...
  return (
    <div className="flex h-screen w-full overflow-hidden bg-[#0c2340] text-white selection:bg-cyan-500 selection:text-navy-950 font-sans relative">
      ...
      <main className="flex-1 h-full overflow-y-auto flex flex-col justify-between bg-[#0c2340]">
        ...
        <footer className="w-full border-t border-navy-800 bg-[#091a30] p-8 mt-auto">
          <Footer />
        </footer>
      </main>
