...
export function App() {
  ...
  return (
    <div className="flex h-screen w-full overflow-hidden bg-[#f0f9ff] text-slate-900 selection:bg-sky-500 selection:text-white font-sans relative">
      ...
      <main className="flex-1 h-full overflow-y-auto flex flex-col justify-between bg-[#f0f9ff]">
        ...
        <footer className="w-full border-t border-sky-200 bg-white p-8 mt-auto">
          <Footer />
        </footer>
      </main>
